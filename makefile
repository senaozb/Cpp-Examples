...
BoardGame2D:	BoardGame2D.h BoardGame2D.cpp
			g++ -Wall -Wextra -ansi -pedantic-errors -std=c++11 -c BoardGame2D.cpp

PegSolitaire:	PegSolitaire.h PegSolitaire.cpp
			g++ -Wall -Wextra -ansi -pedantic-errors -std=c++11 -c PegSolitaire.cpp

EightPuzzle:	EightPuzzle.h EightPuzzle.cpp
			g++ -Wall -Wextra -ansi -pedantic-errors -std=c++11 -c EightPuzzle.cpp

Klotski:		Klotski.h Klotski.cpp
			g++ -Wall -Wextra -ansi -pedantic-errors -std=c++11 -c Klotski.cpp


main:	BoardGame2D.h PegSolitaire.h EightPuzzle.h Klotski.h main.cpp
			g++ -Wall -Wextra -ansi -pedantic-errors -std=c++11 -c main.cpp
